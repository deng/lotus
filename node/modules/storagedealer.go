...
func StorageDealer(fc config.MinerFeeConfig) func(params StorageDealerParams) (*storage.Dealer, error) {
	return func(params StorageDealerParams) (*storage.Dealer, error) {
		...
		sm, err := storage.NewDealer()
		if err != nil {
			return nil, err
		}

		lc.Append(fx.Hook{
			OnStart: sm.RunDealer,
...
func DealerSectorStorage() (*sectorstorage.Manager, error) {
	return nil, nil
}

// RetrievalProvider creates a new retrieval provider attached to the provider blockstore
func RetrievalProviderDealer(h host.Host,
	sealingApi lapi.Sealer,
	full lapi.FullNode,
